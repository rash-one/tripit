<template>
  <div class="container mx-auto px-4 w-full">
     <button @click="$i18n.locale = 'EN' "  class="bg-[#000000] hover:bg-[#feaf55] text-white px-4 py-2 rounded-lg mx-2">EN   </button>
    <button @click="$i18n.locale = 'AR' " class="bg-[#000000] hover:bg-[#feaf55] text-white px-4 py-2 rounded-lg mx-2">AR   </button>
