...
export default {
  ...
  methods: {
    ...
    getalltrips() {
      axios
        .get(
          "https://dqorskomhqezaztrdhzc.supabase.co/rest/v1/trips?select=id,created_at,creator_id,location_id,title,image_name,start_date,end_date,description,users!inner(*),locations!inner(*),trips_images!fk_trips(id,created_at,image_name)",
          {
            headers: {
              apikey:
